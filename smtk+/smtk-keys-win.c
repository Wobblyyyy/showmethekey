...
enum { PROP_0, PROP_MODE, PROP_SHOW_MOUSE, PROP_TIMEOUT, PROP_FONTSIZE, N_PROPERTIES };
        ...
        const GValue *value, GParamSpec *pspec)
{
    ...
    switch (property_id) {
        ...
        case PROP_TIMEOUT:
            ...
            break;
        case PROP_FONTSIZE:
            win->fontsize = g_value_get_int(value);
            break;
        default:
        ...
        GValue *value, GParamSpec *pspec)
{
    ...
    switch (property_id) {
        ...
        case PROP_TIMEOUT:
            ...
            break;
        case PROP_FONTSIZE:
            g_value_set_int(value, win->fontsize);
        default:
            /* We don't have any other property... */
            G_OBJECT_WARN_INVALID_PROPERTY_ID(object, property_id, pspec);
            break;
...
static void smtk_keys_win_emitter_on_update_label(SmtkKeysWin *win,
        ...
        SmtkKeysEmitter *emitter)
{
    GtkLabel *label = GTK_LABEL(win->keys_label);
        ...
        gpointer user_data)
{
    ...
    pango_font_description_set_size(font,
            allocation->height * (win->fontsize / 100.0) * PANGO_SCALE);
...
static void smtk_keys_win_class_init(SmtkKeysWinClass *win_class)
{
    ...
    obj_properties[PROP_TIMEOUT] = g_param_spec_int(
            ...
            G_PARAM_CONSTRUCT_ONLY | G_PARAM_READWRITE);
    obj_properties[PROP_FONTSIZE] = g_param_spec_int(
            "fontsize", "Font Size Coefficient", "Font Size Coefficient", 1, 1000, 10,
            G_PARAM_CONSTRUCT_ONLY | G_PARAM_READWRITE);
